---
title: 'Agent Activation Prompts'
description: 'Ready-to-use prompt templates for activating any agent within the NEXUS pipeline'
---
...
<CardGroup cols={2}>
  <Card title="UX Architect" icon="drafting-compass">
    ```
...
<Accordion title="Sprint Prioritizer">
```
...
<Accordion title="Executive Summary Generator">
```
